...
const SUB_PATH = process.env.SUB_PATH || 'qiqi';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '6980c69a-f6d3-49f8-a3c8-1eefc882ddf4'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NAME = process.env.NAME || 'qiqi258';                        // 节点名称
